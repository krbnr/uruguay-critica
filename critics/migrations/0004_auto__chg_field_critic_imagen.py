...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'critic.imagen'
        db.alter_column('critics_critic', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'critic.imagen'
        db.alter_column('critics_critic', 'imagen', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
