...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'critic.Descripcion_personal'
        db.delete_column('critics_critic', 'Descripcion_personal')

        # Adding field 'critic.frase_favorita'
        db.add_column('critics_critic', 'frase_favorita',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'critic.Descripcion_personal'
        db.add_column('critics_critic', 'Descripcion_personal',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'critic.frase_favorita'
        db.delete_column('critics_critic', 'frase_favorita')
    ...
    models = {
        ...
        'critics.critic': {
            ...
            'frase_favorita': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
